...
@section('content')
    ...
    <div class="gallery py-5" id="videos">
        <div class="container py-3">
                ...
                @foreach ($videos as $video) 
                    <div class="carousel-item @if($loop->first) active @endif">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" width="560" height="315" src="{{ $video->src }}" allowfullscreen></iframe>
                        </div>
                    </div>
                @endforeach
                </div>
        ...
        <div class="container py-3">
            ...
            <div class="row contact-grids">
                <div class="col-lg-5 contact-left">
                    <h4 class="mb-4">Informações de Endereço</h4>
                    <div class="row">
                        ...
                        <div class="col-11 mt-4">
                            <h5>Endereço</h5>
                            <p>R. Tenreiro Aranha, 209 - Parque Beira Mar,</p>
                            <p> Duque de Caxias - RJ, 25085-390</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 mt-lg-0 mt-5 contact-right">
                    <h4 class="mb-4">Entrar em contato</h4>
